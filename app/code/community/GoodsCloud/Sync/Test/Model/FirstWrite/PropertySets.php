...
class GoodsCloud_Sync_Test_Model_FirstWrite_PropertySets
    extends EcomDev_PHPUnit_Test_Case
{
    ...
    public function testCreatePropertySet()
    {
        ...
        $apiMock = $this->getModelMock('goodscloud_sync/api',
            array('createPropertySet'), false, array(), '', false);
        ...
        $firstWritePropertySets->createPropertySetsFromAttributeSets($attributeSets,
            $stores);
